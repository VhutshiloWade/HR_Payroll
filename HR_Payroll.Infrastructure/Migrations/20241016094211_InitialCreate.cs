        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmployeeId = table.Column<int>(type: "int", nullable: false),
                    VacationDays = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SickDays = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PersonalDays = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeOffType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PayrollBenefits_PayrollRecords_PayrollRecordId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollBenefits_PayrollRecordId",
